...
define('BASE_URL', 'http://localhost/projecten/TickIt/TickIt_Web/');

/**
 * Credentials
 */
define('DB_NAME', 'tickit');
...
define('EVENT_READS', BASE_URL . 'events/reads');
define('EVENT_CREATE', BASE_URL . 'events/create');
define('EVENT_UPDATE', BASE_URL . 'events/update');
define('EVENT_DELETE', BASE_URL . 'events/delete');

define('CHECKOUT_ORDER', BASE_URL . 'checkout/order');
define('CHECKOUT_TRANSACTION', BASE_URL . 'checkout/transaction');
